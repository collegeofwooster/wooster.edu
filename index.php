...
$args['cat'] = '-1105,-1106,-1066,-644,-945,-690,-1292,-1328,-1364,-1419,-1474,-1587,-1592';
		...
		<div class="wrap">
		    ...
		    <div class="article-filter">
		    	...
		    	<div class="browse-by-category">
		    		<?php wp_dropdown_categories( array( 'show_option_all' => 'Select Category', 'value_field' => 'slug', 'class' => 'category-select', 'orderby' => 'name', 'exclude' => array( 1105, 1106, 1066, 644, 945, 690, 1292, 1328, 1364, 1419, 1592 ) ) ); ?>
		    	</div>
